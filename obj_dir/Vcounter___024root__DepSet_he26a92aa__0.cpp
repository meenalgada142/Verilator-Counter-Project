...
void Vcounter___024root___eval(Vcounter___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    vlSelfRef.__Vsampled_TOP__reset = vlSelfRef.reset;
    ...
    vlSelfRef.__Vsampled_TOP__counter__DOT__count_q 
        = vlSelfRef.counter__DOT__count_q;
    vlSelfRef.__Vsampled_TOP__counter__DOT___Vpast_3_0 
        = vlSelfRef.counter__DOT___Vpast_3_0;
    vlSelfRef.__Vsampled_TOP__counter__DOT___Vpast_5_0 
        = vlSelfRef.counter__DOT___Vpast_5_0;
    vlSelfRef.__Vsampled_TOP__en = vlSelfRef.en;
